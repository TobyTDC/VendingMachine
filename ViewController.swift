...
class ViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    @IBAction func Purchase() {
        if let currentSelection = currentSelection {
            do {
                ...
                showAlert(title: "Out of stock", message: "This item is not avaliable. Please make another selection")
            } catch VendingMachineError.invalidSelection{
                showAlert(title: "Invalid Selection", message: "Please make a selection")
            } catch VendingMachineError.insufficientFunds(let required){
                showAlert(title: "Insufficient Funds", message: "You need $\(required) to complete the transaction")
            } catch let error {
                fatalError("\(error)")
            }
            ...
            // FIXME: Alert user to know selection
        }
    }
    ...
    func updateTotalPrice(from item: VendingItem){
