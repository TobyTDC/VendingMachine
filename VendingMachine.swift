...
//  VendingMachine
//
//  Created by toby tang on 2017-10-17.
...
enum InventoryError: Error {
    case invalidResuorce
    case conversionError
    case invalidSelection
}

class PlistConverter { // we don't need to create an instance of the data
    static func dictionary(fromFile name: String, ofType type: String) throws -> [String : AnyObject]{
        guard let path = Bundle.main.path(forResource: name, ofType: type) else {
            
            throw InventoryError.invalidResuorce
    ...
    }  // making the method a type method, could be called directly with the type
}
